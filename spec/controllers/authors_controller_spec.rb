...
RSpec.describe AuthorsController, type: :controller do
  ...
  let(:valid_attributes) {
    { full_name: Faker::Book.author, birth: Faker::Date.birthday(18, 65), bio: Faker::Lorem.paragraph(2) }
  }

  let(:invalid_attributes) {
    { full_name: nil, birth: Faker::Date.birthday(18, 65), bio: Faker::Lorem.paragraph(2) }
  }
